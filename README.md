...
![Beginner](https://img.shields.io/badge/difficulty-beginner-22C55E) ![Data Science](https://img.shields.io/badge/course-Data%20Science-0056CE) ![8 hours](https://img.shields.io/badge/estimated-8h-lightgrey)

> **Square 1 AI** starter template — Data Science

## Overview

In this introductory project, you'll build a **Exploratory Data Analysis Tool** using Python, Pandas, Matplotlib. Build an automated EDA tool that profiles any CSV dataset. This is a hands-on project where you'll write real code, solve real problems, and build something you can showcase in your portfolio.
...
```bash
# Clone this template
git clone https://github.com/nikhildesilva-squareai/starter-exploratory-data-analysis-tool.git
cd starter-exploratory-data-analysis-tool
